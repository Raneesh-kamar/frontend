              ...
              <div className="space-x-4">
                ...
                <Link to="/socratic">
                  <button className="bg-white/20 text-gray-900 px-8 py-3 rounded-lg font-medium hover:bg-gray-300/50 transition duration-300">
                    Socratic Learning Machines
                  </button>
                </Link>
                {/* Link to MCQ.js */}
                <Link to="/mcq">
                  <button className="bg-white/20 text-gray-900 px-8 py-3 rounded-lg font-medium hover:bg-gray-300/50 transition duration-300">
                    Socratic AI Assessment
                  </button>
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/30 backdrop-blur-md rounded-2xl p-8 shadow-lg border border-white/20">
            ...
            <div className="space-y-4">
              <button className="bg-blue-600/90 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700/90 transition duration-300 w-full md:w-auto">
                Request a Demo
              </button>
              <button className="bg-gray-800/90 text-white px-8 py-3 rounded-lg font-medium hover:bg-gray-900/90 transition duration-300 w-full md:w-auto md:ml-4">
                Start Free Trial
              </button>
            </div>
          </div>
